          ...
          function MDCRippleFoundation(adapter) {
            ...
            var _this = _possibleConstructorReturn(
              ...
              (
                ...
                this,
                _extends(MDCRippleFoundation.defaultAdapter, adapter)
              )
            );
            ...
            _this.focusHandler_ = function() {
              return requestAnimationFrame(function() {
                return _this.adapter_.addClass(
            ...
            _this.blurHandler_ = function() {
              return requestAnimationFrame(function() {
                return _this.adapter_.removeClass(
                  MDCRippleFoundation.cssClasses.BG_FOCUSED
                );
              });
            };
          ...
          _createClass(MDCRippleFoundation, [
            ...
            },
            {
              ...
              value: function registerRootHandlers_() {
                ...
                ACTIVATION_EVENT_TYPES.forEach(function(type) {
                  _this4.adapter_.registerInteractionHandler(
                    type,
                    _this4.activateHandler_
                  );
                });
              ...
              value: function registerDeactivationHandlers_(e) {
                ...
                if (e.type === "keydown") {
                  ...
                  POINTER_DEACTIVATION_EVENT_TYPES.forEach(function(type) {
                    _this5.adapter_.registerDocumentInteractionHandler(
                      type,
                      _this5.deactivateHandler_
                    );
                  });
                }
              }
            ...
            },
            {
              ...
              value: function deregisterRootHandlers_() {
                ...
                ACTIVATION_EVENT_TYPES.forEach(function(type) {
                  _this6.adapter_.deregisterInteractionHandler(
                    type,
                    _this6.activateHandler_
                  );
                });
            ...
            },
            {
              ...
              value: function deregisterDeactivationHandlers_() {
                ...
                POINTER_DEACTIVATION_EVENT_TYPES.forEach(function(type) {
                  _this7.adapter_.deregisterDocumentInteractionHandler(
                    type,
                    _this7.deactivateHandler_
                  );
                });
              }
              ...
              value: function activate_(e) {
                ...
                requestAnimationFrame(function() {
                  ...
                  if (
                    ...
                    activationState.wasElementMadeActive = _this9.checkElementMadeActive_(
                      e
                    );
                    if (activationState.wasElementMadeActive) {
              ...
              value: function getFgTranslationCoordinates_() {
                var _activationState_ = this.activationState_,
                  ...
                  wasActivatedByPointer =
                    _activationState_.wasActivatedByPointer;
            ...
            },
            {
              ...
              value: function deactivate_(e) {
                ...
                var state = /** @type {!ActivationStateType} */ _extends(
                  {},
                  activationState
                );
              ...
              value: function layoutInternal_() {
                ...
                var getBoundedRadius = function getBoundedRadius() {
                  var hypotenuse = Math.sqrt(
                    Math.pow(_this15.frame_.width, 2) +
                      Math.pow(_this15.frame_.height, 2)
                  );
